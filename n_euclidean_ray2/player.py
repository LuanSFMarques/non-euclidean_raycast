...
class Player:
    ...
    def draw(self):
        ...
        # Player 2
        '''
        pg.draw.line(self.game.screen, 'yellow', (self.x+HEIGHT_2, self.y),
                     (self.x + HEIGHT_2 + WIDTH//3 * math.cos(self.angle),
                      self.y + WIDTH//3 * math.sin(self.angle)), 2)
        '''
        pg.draw.circle(self.game.screen, '#FFB36B', (self.x+HEIGHT_2, self.y), 8)
